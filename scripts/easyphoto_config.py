...
easyphoto_video_outpath_samples = os.path.join(
    data_dir, 'outputs/easyphoto-video-outputs')
user_id_outpath_samples = os.path.join(
    data_dir, 'outputs/easyphoto-user-id-infos')
cloth_id_outpath_samples = os.path.join(
    data_dir, 'outputs/easyphoto-cloth-id-infos')

scene_id_outpath_samples = os.path.join(
    data_dir, 'outputs/easyphoto-scene-id-infos')
cache_log_file_path = os.path.join(
    data_dir, "outputs/easyphoto-tmp/train_kohya_log.txt")
...
# scene lora
DEFAULT_SCENE_LORA = ['Christmas_1', 'Cyberpunk_1', 'FairMaidenStyle_1', 'Gentleman_1', 'GuoFeng_1', 'GuoFeng_2', 'GuoFeng_3',
                      'GuoFeng_4', 'Minimalism_1', 'NaturalWind_1', 'Princess_1', 'Princess_2', 'Princess_3', 'SchoolUniform_1', 'SchoolUniform_2']
# ModelName
