...
from scripts.easyphoto_utils import check_id_valid,check_files_exists_and_download,check_scene_valid
                    ...
                    with gr.Blocks() as demo:
                        with gr.Row():
                            with gr.Column():
                                with gr.Tabs(elem_id="mode_easyphoto_photo_inference"):
                                    with gr.TabItem("Photo2Photo") as template_images_tab:
                                        upload_way = gr.Radio(["Template Gallery", "Single Image Upload", "Batch Images Upload"], value="Template Gallery", show_label=False, elem_id='mode_photo_to_photo')
                                        ...
                                        with gr.Column(elem_id="mode_single_image_upload", visible=False) as single_image_upload:
                                            init_image_photo_inference = gr.Image(label="Image for skybox", elem_id="{id_part}_image", show_label=False, source="upload")
                            ...
                            with gr.Column():
                                ...
                                photo_infer_output_images.select(select_function, photo_infer_output_images, selected_photo_infer_output_image)
                ...
                with gr.Blocks() as demo:
                    with gr.Row():
                        with gr.Column():
                            ...
                            template_image_tryon = gr.Image(label="Image for skybox", elem_id="{id_part}_tem_image", show_label=False, source="upload", tool='sketch')
                        ...
                        with gr.Column():
                            ...
                            tryon_output_images.select(select_function, tryon_output_images, selected_tryon_output_image)
                            ...
                            buttons_tryon['easyphoto'].click(fn=select_single_image_upload,
                                ...
                                inputs = [],
                                outputs = [upload_way, template_gallery, single_image_upload, batch_images_upload]
                            )
