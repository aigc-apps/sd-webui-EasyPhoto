...
import open_clip
from ldm_anydoor.util import default, count_params
from PIL import Image
from open_clip.transform import image_transform
import sys
import os
from scripts.easyphoto_config import DINOv2_weight_path
# DINOv2_weight_path = '/mnt/xinyi.zxy/easyphoto/sdwebui/extensions/sd-webui-EasyPhoto/models/dinov2_vitg14_pretrain.pth'
...
# sys.path.append(os.path.join("./dinov2"))
import hubconf
from omegaconf import OmegaConf
# config_path = './configs/anydoor.yaml'
config_path = os.path.join(os.path.abspath(os.path.dirname(__file__)), '../../../','configs/anydoor.yaml')
